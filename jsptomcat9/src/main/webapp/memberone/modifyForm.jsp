...
%>
<body>
<form action="/jsptest/memberone/modifyProc.jsp" method="post"
		name="regForm">
		<table border="1">
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="zipcode" value="<%=vo.getZipcode() %>"/> <input type="button"
			...
			<tr>
				<td colspan="2" align="right"><input type="button" value="정보수정"
					onclick="updateCheck()" />&nbsp;&nbsp; <input type="reset"
					value="취소" onclick="javasacript:window.location='login.jsp'" /></td>
			</tr>
		</table>
	</form>
</body>
